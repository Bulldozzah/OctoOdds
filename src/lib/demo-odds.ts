...
// `updated: 0` means "the feed didn't say", which is how sample data should
// read: the freshness filter keeps unstamped quotes, so demo scans behave the
// same however long the page has been open — and no timestamp gets baked into
// the SSR output to disagree with the client.
